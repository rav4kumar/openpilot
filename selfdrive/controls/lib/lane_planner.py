  ...
  def update_d_poly(self, v_ego):
    ...
    if travis:
      ...
      if self.last_modified != self.modified:
        self.dp_camera_offset, self.last_modified_dp_camera_offset = param_get_if_updated("dp_camera_offset", "int", self.dp_camera_offset, self.last_modified_dp_camera_offset)  #pylint: disable=too-many-arguments
