...
def thermald_thread():
  ...
  while 1:
    ...
    if last_modified != modified:
      dp_temp_monitor = param_get_if_updated("dp_temp_monitor", "bool", dp_temp_monitor)
      dp_last_modified_temp_monitor = param_get_if_updated("dp_temp_monitor", "bool", dp_last_modified_temp_monitor)
      dp_auto_shutdown = param_get_if_updated("dp_auto_shutdown", "bool", dp_auto_shutdown)
      dp_last_modified_auto_shutdown = param_get_if_updated("dp_auto_shutdown", "bool", dp_last_modified_auto_shutdown)
      dp_auto_shutdown_in = param_get_if_updated("dp_auto_shutdown_in", "int", dp_auto_shutdown_in)
      dp_last_modified_auto_shutdown_in = param_get_if_updated("dp_auto_shutdown_in", "int", dp_last_modified_auto_shutdown_in)
