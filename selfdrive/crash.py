...
error_tags = {'dirty': dirty, 'dongle_id': dongle_id, 'branch': branch, 'remote': origin,
              ...
              'ArizonaMode': ArizonaMode, 'dynamic_gas_mod': dynamic_gas_mod,
              'keep_openpilot_engaged': keep_openpilot_engaged,
              'prius_pid': prius_pid, 'use_car_caching': use_car_caching,
