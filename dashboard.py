      ...
      if socket is live100:
        ...
        for l100 in _live100:
          ...
          if vEgo > 0 and active:
            dat = l100.live100
            #print(dat)
            influxDataString += ("%0.3f,%0.3f,%0.3f,%0.2f,%0.2f,%d,%0.2f,%0.2f,%0.3f,%0.3f,%0.2f,%0.2f,%0.2f,%d,%0.1f,%0.4f,%0.4f,%0.4f,%0.4f,%d|" %
                (dat.dampCenterOffset, dat.angleAccel ,dat.dampAngleRate, dat.angleRate,dat.dampAngleSteers , dat.steeringRequested, dat.noiseFeedback, dat.standardFFRatio,
