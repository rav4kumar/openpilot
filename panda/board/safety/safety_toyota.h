...
// longitudinal limits
const int TOYOTA_MAX_ACCEL = 3500;        // 1.5 m/s2
const int TOYOTA_MIN_ACCEL = -3500;       // -3.0 m/s2

const int TOYOTA_ISO_MAX_ACCEL = 4000;        // 2.0 m/s2
const int TOYOTA_ISO_MIN_ACCEL = -5000;       // -3.5 m/s2
